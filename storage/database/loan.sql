...
-- ----------------------------
INSERT INTO `admin_menu` VALUES (1, 0, 1, 'Index', 'feather icon-bar-chart-2', '/', '', 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_menu` VALUES (2, 0, 2, 'Admin', 'feather icon-settings', '', '', 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_menu` VALUES (3, 2, 3, 'Users', '', 'auth/users', '', 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_menu` VALUES (4, 2, 4, 'Roles', '', 'auth/roles', '', 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_menu` VALUES (5, 2, 5, 'Permission', '', 'auth/permissions', '', 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_menu` VALUES (6, 2, 6, 'Menu', '', 'auth/menu', '', 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_menu` VALUES (7, 2, 7, 'Extensions', '', 'auth/extensions', '', 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_menu` VALUES (8, 0, 8, '贷款管理', 'fa-align-justify', NULL, '', 1, '2022-04-25 14:54:02', '2022-04-25 14:54:02');
INSERT INTO `admin_menu` VALUES (9, 8, 9, '贷款列表', 'fa-align-justify', 'orders', '', 1, '2022-04-25 14:54:55', '2022-04-25 14:54:55');
INSERT INTO `admin_menu` VALUES (10, 8, 10, '贷款产品', 'fa-anchor', 'products', '', 1, '2022-04-29 14:17:16', '2022-04-29 14:18:19');
...
-- ----------------------------
INSERT INTO `admin_permission_menu` VALUES (1, 8, '2022-04-25 14:54:02', '2022-04-25 14:54:02');
INSERT INTO `admin_permission_menu` VALUES (1, 10, '2022-04-29 14:17:16', '2022-04-29 14:17:16');
INSERT INTO `admin_permission_menu` VALUES (2, 8, '2022-04-25 14:54:02', '2022-04-25 14:54:02');
INSERT INTO `admin_permission_menu` VALUES (2, 10, '2022-04-29 14:17:16', '2022-04-29 14:17:16');
INSERT INTO `admin_permission_menu` VALUES (3, 8, '2022-04-25 14:54:02', '2022-04-25 14:54:02');
INSERT INTO `admin_permission_menu` VALUES (3, 10, '2022-04-29 14:17:16', '2022-04-29 14:17:16');
INSERT INTO `admin_permission_menu` VALUES (4, 8, '2022-04-25 14:54:02', '2022-04-25 14:54:02');
INSERT INTO `admin_permission_menu` VALUES (4, 10, '2022-04-29 14:17:16', '2022-04-29 14:17:16');
INSERT INTO `admin_permission_menu` VALUES (5, 8, '2022-04-25 14:54:02', '2022-04-25 14:54:02');
INSERT INTO `admin_permission_menu` VALUES (5, 10, '2022-04-29 14:17:16', '2022-04-29 14:17:16');
INSERT INTO `admin_permission_menu` VALUES (6, 8, '2022-04-25 14:54:02', '2022-04-25 14:54:02');
INSERT INTO `admin_permission_menu` VALUES (6, 10, '2022-04-29 14:17:16', '2022-04-29 14:17:16');
...
-- ----------------------------
INSERT INTO `admin_permissions` VALUES (1, 'Auth management', 'auth-management', '', '', 1, 0, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_permissions` VALUES (2, 'Users', 'users', '', '/auth/users*', 2, 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_permissions` VALUES (3, 'Roles', 'roles', '', '/auth/roles*', 3, 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_permissions` VALUES (4, 'Permissions', 'permissions', '', '/auth/permissions*', 4, 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_permissions` VALUES (5, 'Menu', 'menu', '', '/auth/menu*', 5, 1, '2022-04-24 17:47:52', NULL);
INSERT INTO `admin_permissions` VALUES (6, 'Extension', 'extension', '', '/auth/extensions*', 6, 1, '2022-04-24 17:47:52', NULL);
...
-- ----------------------------
INSERT INTO `admin_role_menu` VALUES (1, 8, '2022-04-25 14:54:02', '2022-04-25 14:54:02');
INSERT INTO `admin_role_menu` VALUES (1, 10, '2022-04-29 14:17:16', '2022-04-29 14:17:16');
...
-- ----------------------------
INSERT INTO `admin_role_users` VALUES (1, 1, '2022-04-24 17:47:52', '2022-04-24 17:47:52');
...
-- ----------------------------
INSERT INTO `admin_roles` VALUES (1, 'Administrator', 'administrator', '2022-04-24 17:47:52', '2022-04-24 17:47:52');
...
-- ----------------------------
INSERT INTO `admin_users` VALUES (1, 'admin', '$2y$10$p7BY2xcocrLZeRKi/hdFzON2B07hnxq5yBi9NyGZrgy1gBg3Ynu9a', 'Administrator', NULL, 'Aww4X9wRjvvOGi2g9QghN7X7ieF4QPwGiI5KdKSpQ0sf9iyUA5VrCAAV55sb', '2022-04-24 17:47:52', '2022-04-24 17:47:52');
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资产账龄统计' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `statistics_daily_cashflow`  (
  ...
  UNIQUE INDEX `idx_analysis_date`(`analysis_date`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '日流水分析' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `statistics_daily_ledger`  (
  ...
  UNIQUE INDEX `idx_analysis_date`(`analysis_date`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '台账日报分析' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `statistics_daily_pl`  (
  ...
  PRIMARY KEY (`daily_cashflow_id`) USING BTREE,
  UNIQUE INDEX `idx_analysis_date`(`analysis_date`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '日损益分析' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `statistics_operation_data`  (
  ...
  UNIQUE INDEX `idx_analysis_date`(`analysis_date`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '运营数据日报' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `users`  (
  ...
  `is_finished_verify` tinyint(255) NULL DEFAULT 0 COMMENT '是否完成验证 0-未完成 1-完成',
