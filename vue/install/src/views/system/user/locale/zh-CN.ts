export default {
    ...
    'systemUser.list.ID': '用户ID',
    'systemUser.list.username': '用户名称',
    'systemUser.list.name': '登录账户',
    'systemUser.list.createTime': '创建时间',
    'systemUser.list.status': '用户状态',
    'systemUser.form.status.enable': '启用',
    'systemUser.form.status.disabled': '禁用',
};